...
class TensorData:
    ...
    def to_cuda_(self) -> None:  # pragma: no cover
        ...
        try:
            ...
            raise RuntimeError(
                "CUDA support is not available in your Numba installation."
            )
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        ...
        elif isinstance(index, tuple):  # Use elif to ensure only one branch is executed
            aindex = array(index)
        else:
            raise IndexingError("Index must be an int or a tuple.")
    ...
    def tuple(self) -> Tuple[Storage, Shape, Strides]:
        """Return the storage, shape, and strides as a tuple."""
    ...
    def to_string(self) -> str:
        ...
        for index in self.indices():
            ...
            s += l
            v = self.get(index)
            s += f"{v:3.2f}"  # Use `+=` for string concatenation
            l = ""
            for i in range(len(index) - 1, -1, -1):
